<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Homepage.aspx.cs" Inherits="The_Queens_Restaurant.Homepage" %>
          ...
          <nav class="rd-navbar rd-navbar-default rd-navbar-transparent" data-auto-height="true" data-md-layout="rd-navbar-fixed" data-lg-layout="rd-navbar-static" data-lg-stick-up="true">
            <div class="rd-navbar-inner">
              ...
              <div class="rd-navbar-panel">
                ...
                <!--Navbar Brand-->
                <div class="rd-navbar-brand"><a href="Homepage.aspx"></a><h1 style="margin-top: -16px;margin-left: -15px;">
              ...
              <div class="container">
                <div class="section-110 section-cover row justify-content-sm-center align-items-sm-center">
                  <div class="col-lg-8"><img src="images/intro-logo-175x173.png" alt="" width="175" height="173"/>
                    ...
                    <div class="group">
                      <div class="group-item d-block"><span class="icon icon-xxs mdi mdi-navigation text-middle"></span> <span class="text-middle"><a class="link-white" href="#">Queensgate Lower Hutt 5011</a></span>
                      </div>
                      ...
                      <div class="group-item"><span class="icon icon-xxs mdi mdi-phone text-middle"></span> <span class="text-middle"><a class="link-white" href="tel:#">+648002345678</a></span>
                      </div>
                    </div>
              ...
              <div class="col-md-8 col-xl-6">
                <div class="shadow-drop-xl">
                  ...
                  <div class="embed-responsive embed-custom-16by9">
                    <iframe class="embed-responsive-item lazy-loaded" data-src="https://www.youtube.com/embed/MG6jHxAfwQk?wmode=transparent" src="https://www.youtube.com/embed/MG6jHxAfwQk?wmode=transparent"></iframe>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-12">
              <div class="row justify-content-sm-center">
                ...
                <div class="col-sm-12 offset-top-66 col-xl-3 order-xl-1 offset-xl-top-0 order-lg-3">
                  <!-- Footer brand-->
                  <div class="footer-brand"><a href="Homepage.aspx"></a><h1 style="margin-top: -16px;margin-left: 0px;">
